...
from src.infrastructure.persistence.mysql.session_models import CVSessionORM
...
# ConfigParser treats '%' as interpolation; escape it for passwords with encoded chars.
